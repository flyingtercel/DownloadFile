...
public class OkManager {
    private File rootFile;</br>
    private File file;</br>
    private long downLoadSize;</br>
    private final ThreadPoolExecutor executor;</br>
    private boolean isDown = false;</br>
    private String name;</br>
    private String path;</br>
    private RandomAccessFile raf;</br>
    private long totalSize = 0;</br>
    private MyThread thread;</br>
    private Handler handler;</br>
    private DownLoad.IProgress progress;</br>
```
```
